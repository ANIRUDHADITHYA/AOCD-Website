                ...
                <table className="com-table-container" style={{tableLayout:'fixed'}}>
                    ...
                    <tr>
                        ...
                        <td className="dowload-section"><i className="fa-solid fa-download"/>
                            <a href={"https://aocd-backend.herokuapp.com/static/2D STR/"+data.accession_no+'.sdf'} download>
                                SDF -2D Structure
                            </a> 
                        </td>
                        <td className="dowload-section"><i className="fa-solid fa-download"/>
                            <a href={"https://aocd-backend.herokuapp.com/static/3D STR/"+data.accession_no+'.sdf'} download>
                                SDF -3D Structure
                            </a> 
                        </td>
                    </tr>
