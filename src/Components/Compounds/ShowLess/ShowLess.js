...
const ShowLess = (props) => {
    ...
    const onSubmit = async (event) => {
		...
		window.location = "/summary/" + props.index;
	};
        ...
        <div>
            {
                (props.filter===1) && (props.compound.filter_id==='PL' || props.compound.filter_id==='PL_AS_AG' || props.compound.filter_id==='PL_AS' || props.compound.filter_id==='PL_AG') ? (
                    <div className="showless-container">
                        ...
                        <div className='compound-details'><h4>PUBCHEM ID: </h4><p><a target='_blank' href={'https://pubchem.ncbi.nlm.nih.gov/#query='+props.compound.pubchem_cid}>{props.compound.pubchem_cid}</a></p></div>
                        ...
                        <div className="compound-footer" onClick={onSubmit}>Summary</div>
